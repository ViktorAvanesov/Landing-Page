...
import { ReactComponent as Musicsm } from '../../images/mobile/Musicsm.svg'
import { ReactComponent as Artsm } from '../../images/mobile/Artsm.svg'
import { ReactComponent as Photographysm } from '../../images/mobile/Photographysm.svg'
        ...
        <div className='sm:flex sm:flex-col sm:w-[290px] sm:h-[527px] my-0 mx-auto
            ...
            <div className='md:mt-[199px] md:ml-11
                ...
                <div className='flex sm:hidden md:block xl:block'>
                  ...
                  <Vector className='relative sm:top-[-34px] sm:left-[141px]' />
              </div>
            </div>
        </div>
        ...
        <div className='sm:w-[290px] sm:h-[244px] sm:mt-[46px] sm:my-0 sm:mx-auto
          ...
          <ul className='sm:flex sm:flex-col sm:mt-[27px] sm:gap-[22px]
            ...
            <li className='flex flex-row sm:gap-2
              ...
              <Musicsm className='sm:block md:hidden xl:hidden'/>
                <div className='flex flex-col md:gap-4'>
                  <subtitle className='sm:font-semibold sm:text-[15px] leading-[21px] font-Montserrat
                                       md:font-semibold md:text-[21px] '>Music</subtitle>
                  <subtitle className='sm:font-normal sm:text-[14px] leading-[25px] font-Montserrat
                                       md:font-normal md:text-[20px] md:leading-[25px]'>Indie rock | Reggae</subtitle>
                </div>
            </li>
            <li className='flex flex-row sm:gap-2
                                         md:gap-[14px] md:mt-2'>
            <img src={Artmd} alt='' className='sm:hidden md:block xl:block'/>
              <Artsm className='sm:block md:hidden xl:hidden'/>
                <div className='flex flex-col md:gap-[14px]'>
                  <subtitle className='sm:font-semibold sm:text-[15px] leading-[21px] font-Montserrat
                                       md:font-semibold md:text-[21px]'>Art</subtitle>
                  <subtitle className='sm:font-normal sm:text-[14px] leading-[28px] font-Montserrat
                                       md:font-normal md:text-[20px] md:leading-[25px]'>Edvard Munch | Frida Kahlo</subtitle>
                </div>
            </li>
            <li className='flex flex-row sm:gap-2
                                         md:gap-4'>
            <img src={Photographymd} alt='' className='sm:hidden md:block xl:block'/>
              <Photographysm className='sm:block md:hidden xl:hidden'/>
                <div className='flex flex-col md:gap-[10px]'>
                  <subtitle className='sm:font-semibold sm:text-[14.5px] leading-[24px] font-Montserrat
                                       md:font-semibold md:text-[21px] md:leading-[33px]'>Photography</subtitle>
                  <subtitle className='sm:font-normal sm:text-[14px] leading-[25px] font-Montserrat
                                       md:font-normal md:text-[20px] md:leading-[25px]'>Portraits</subtitle>
                </div>
            </li>
          </ul>
        </div>
          ...
          <h3 className='sm:font-semibold sm:text-[20.5px] leading-[30px] font-Montserrat
             ...
             <ul className='sm:mt-[27px] sm:gap-[12px] flex flex-col
              ...
              <div className='flex sm:block md:hidden xl:hidden'>
                  ...
                  <Vector className='relative sm:top-[-27px] sm:left-[108px]' />
              </div>
        </div>
      </div>  
    </div>
