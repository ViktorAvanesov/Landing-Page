...
import { ReactComponent as Photo } from '../../images/mobile/Photo.svg'
  ...
  return (
    <div className='sm:w-80 sm:h-[504px] sm:my-0 sm:mx-auto sm:pt-[1px]
        ...
        <div className='w-[25px] h-[3px] bg-buttonAndLine sm:mt-7 sm:ml-[14px]
            ...
            <Vector className='relative sm:top-[-29px] sm:left-[123px]
                                        md:top-[-36px] md:left-[180px]
                                        xl:top-[-34px] xl:left-[226px] ' />

            <Photo className='relative sm:top-[-111px] sm:block xl:hidden md:hidden' />
