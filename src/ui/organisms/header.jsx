...
import { ReactComponent as Logosm } from '../../images/mobile/Logosm.svg'
import { ReactComponent as Menu } from '../../images/mobile/Menu.svg'
export const Header = () => {
  return (
    <div >
        <header className='sm:w-80 sm:h-16 sm:border-b-[1px] sm:my-0 sm:mx-auto sm:flex sm:justify-between sm:pl-4 sm:pr-[10px] sm:py-[13px]
            ...
            <Logosm />
            <button type='button'className='sm:block sm:w-8 sm:h-8 md:hidden xl:hidden'><Menu/></button>
        </header>
    </div>
  )
}
